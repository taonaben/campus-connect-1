					...
					<div class="col-lg">
						<div class="position-relative">
							<div class="slide">
								...
								<img
									src="./assets/img/boarding-houses/bh1.jpg"
									style="width: 100%"
								/>
							</div>
							...
							<div class="slide">
								...
								<img
									src="./assets/img/boarding-houses/bh2.jpg"
									style="width: 100%"
								/>
							</div>
							...
							<div class="slide">
								...
								<img
									src="./assets/img/boarding-houses/bh3.jpg"
									style="width: 100%"
								/>
							</div>
							...
							<div class="slide">
								...
								<img
									src="./assets/img/boarding-houses/bh5.jpg"
									style="width: 100%"
								/>
							</div>
						...
						<div class="mt-4 mt-lg-0">
							<div class="d-flex align-items-start justify-content-between mb-4">
								<div>
									...
									<div class="mb-3"><i class="bi bi-geo"></i> 5km to CUT</div>
								</div>
							...
							<div class="p-3 border bg-light c-rounded-1">
								2 sharing rooms with ensuites. Free transport to and from campus. Wife, Gas Stove, Geyser, Borehole &#9989
								<br /><br />
								<div class="mb-2">
									<i class="bi bi-telephone-fill me-2"></i> +263776658124
								</div>
								<div><i class="bi bi-whatsapp me-2"></i> +263778958116 <br /></div>
							</div>
						</div>
					</div>
				</div>
